...
import { EmptyTransferBaseTokenStep,TransferERC20Step } from "@railgun-community/cookbook";
...
export class MakePaymentIDW3 extends Recipe {
    ...
    private readonly businessAmount: BigNumber;
    private readonly idw3Amount: BigNumber;
	...
	protected async getInternalSteps(): Promise<Step[]> {
		return [
			...
			new TransferERC20Step(this.businessAddress, this.erc20Info,this.businessAmount),
